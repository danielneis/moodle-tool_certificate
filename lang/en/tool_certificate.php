...
$string['displaysharepage'] = 'Display share page';
$string['displaysharepagedesc'] = 'Display a page to share the certificate on social networks instead of forcing the download of the certificate when clicking on the activity on the course page.';
