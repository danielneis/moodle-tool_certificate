...
/**
 * Strings for component 'tool_certificate', language 'pt_br', version '4.3'.
 *
...
$string['notificationmsgcertificateissued'] = 'Olá {$a->fullname},<br /><br />Seu certificado está disponível! Você vai encontrá-lo aqui: <a href="{$a->url}">Meus certificados</a> <br/> 
...
$string['show_link_to_certificate_page'] = 'Mostrar link para a página do certificado';
$string['show_link_to_verification_page'] = 'Mostrar link da página de verificação';
...
$string['subplugintype_certificateelement'] = 'Plugin de elemento de certificado';
